...
import { AddOutlined, ArrowBackOutlined, EditOutlined } from '@mui/icons-material';
...
export function ChargesConfiguration() {
  ...
  return <main className="settings-page"><header className="settings-page-header"><div><p className="settings-eyebrow">Settings / Administration</p><h1>Charges Configuration</h1><p>Configure charges for invoices.</p></div><div className="settings-actions"><Button variant="text" startIcon={<ArrowBackOutlined />} onClick={() => navigate('/settings')}>Back to Settings</Button><Button variant="contained" startIcon={<AddOutlined />} onClick={openNew}>Add Charge</Button></div></header>
