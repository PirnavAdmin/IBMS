...
export const DashboardFilters = ({ values, onChange, onRefresh, onCreate }) => <div className="bd-filters">
  ...
  <button className="bd-refresh" onClick={onRefresh} aria-label="Refresh dashboard"><Refresh /></button>
