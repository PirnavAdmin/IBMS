...
import { CustomerAddresses } from '../src/pages/Customers/components/CustomerAddresses';
import { CustomerOverview } from '../src/pages/Customers/components/CustomerOverview';
import { CustomerInvoices, CustomerPayments } from '../src/pages/Customers/components/CustomerTransactions';
import { CustomerStatement } from '../src/pages/Customers/components/CustomerStatement';
import { CustomerState } from '../src/pages/Customers/components/CustomerShared';
import { DeactivateCustomerDialog } from '../src/pages/Customers/components/DeactivateCustomerDialog';
import { mapDetails } from '../src/pages/Customers/api/customerService';
import { CustomerDetailsPage } from '../src/pages/Customers/pages/CustomerDetailsPage';
import { CustomerListPage } from '../src/pages/Customers/pages/CustomerListPage';
import { CustomerForm } from '../src/pages/Customers/components/CustomerForm';
